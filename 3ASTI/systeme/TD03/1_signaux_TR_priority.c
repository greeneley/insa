...
int main (void)
{
	...
	action.sa_flags = SA_SIGINFO; /* necessaire pour avoir les infos supplementaires */
	...
	sigfillset(& ensemble); // Tous signaux sont armes a 1
	sigprocmask(SIG_UNBLOCK, & ensemble, NULL); // On debloque tous les signaux armes
