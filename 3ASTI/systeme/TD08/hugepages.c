...
#define MB_8 (8*MB_1)
#define TAILLE (4096*1024)
char  *a;
int shmid1;

void init_hugetlb_seg()
{
  shmid1 = shmget(2, TAILLE , SHM_HUGETLB
         | IPC_CREAT | SHM_R
         | SHM_W);
...
/*
Ajouter ces lignes au fichier /etc/sysctl.conf et redémarrer la machine virtuellle
vm.nr_hugepages = 5
kernel.shmmax = 20971520
vm.hugetlb_shm_group = 0

Tester le programme écrire le même mais sans les pages HUGE et comparer le tempsd'exection*/
