...
public class ProjectionImpl implements Projection 
{
	 ...
	 * Exemple : project([7,8,9,1,0,4,6,7], [1,2,3]) = [7,8,9].
	 * 
	...
	public Nuplet[] project(Nuplet[] t, int[] atts) 
	{
		...
		// ===== Verifications =====
		if(atts.length > t.length)
		{
			System.err.println("Il y a plus d'attributs que de valeurs dans le Nuplet !");
			return null;
		}
		...
		{
			NupletInt nuplet = new NupletInt(atts.length);
